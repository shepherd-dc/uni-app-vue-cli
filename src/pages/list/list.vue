<template>
	<view class="content">
		<view class="section">
		  ...
		  <scroll-view scroll-y style="height: 400px;" @crolltoupper="upper" @scrolltolower="lower" @scroll="scroll" :scroll-into-view="toView" :scroll-top="scrollTop">
			<view v-for="item in order" :key="item" :id="item" :class="['scroll-view-item', 'bc_'+item]" @tap="navigateToDetail(item)"></view>
		  </scroll-view>
